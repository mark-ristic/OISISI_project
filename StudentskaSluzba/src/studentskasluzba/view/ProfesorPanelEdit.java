...
public class ProfesorPanelEdit extends JPanel {
	...
	public static JRadioButton stalni = new JRadioButton("Stalni");
	...
	quit.addActionListener( evt -> md.dispose());
	
	ep.setPreferredSize(new Dimension(105,35));
	ep.setIcon(new ImageIcon("StudentskaSluzba\\images\\round-100x35.png"));
	ep.setFocusPainted(false);
	ep.setBorderPainted(false);
	ep.setContentAreaFilled(false);
	ep.setOpaque(false);
	
	quit.setPreferredSize(new Dimension(105,35));
	quit.setIcon(new ImageIcon("StudentskaSluzba\\images\\quit.png"));
