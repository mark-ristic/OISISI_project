...
public class PredmetPanelAdd extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2729851297492335293L;
	
	// (String sifra, String naziv, String semestar, int godIzv, Profesor predProf, ArrayList<Student> studenti)
	...
	public static JComboBox<String> comboGod = new JComboBox<>(godine);
		...
		PredmetPanelAdd(MyDialog md, final JFrame parent, int width, int height) {
			...
			dodaj.setPreferredSize(new Dimension(125,35));
